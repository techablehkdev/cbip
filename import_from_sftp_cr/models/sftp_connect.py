    ...
    def test_connection(self):
        ...
        try:
            ...
            if self.with_password:
                ssh.connect(self.host_name, port=22, username=self.username, password=self.password)
            else:
                ssh.connect(self.host_name, port=22, username=self.username, password=self.password,
    ...
    def _read_from_sftp_and_import(self):
        ...
        for import_config in import_config_ids:
            ...
            if import_config.sftp_host.with_password:
                ...
                ssh.connect(hostname, port=22, username=username, password=password, key_filename=import_config.sftp_host.public_key_path)
